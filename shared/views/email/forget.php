<?php $v->layout("_theme", ["title" => "Recupere sua senha para acessar a ".CONF_SITE_NAME]); ?>

<h2>Perdeu sua senha <?= $first_name; ?>?</h2>
<p>Você está recebendo este e-mail pois foi solicitado a recuperação de senha no Interface de Controle da CEMF.</p>
